...
def create_shard(i):
    ...
    output_file_path = '{}/part_{:05d}_of_{:05d}.hdf'.format(args.output_hdf5, i, num_shards)
    size_threshold = 36 * 1024 * 1024

    if os.path.exists(output_file_path) and os.path.getsize(output_file_path) > size_threshold:
