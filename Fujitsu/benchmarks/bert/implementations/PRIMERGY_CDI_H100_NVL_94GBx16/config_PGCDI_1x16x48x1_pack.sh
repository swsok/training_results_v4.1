...
#export LR=0.00096
export LR=${CDI_SET_LR:-0.002}
export MAX_SAMPLES_TERMINATION=4500000
#export MAX_STEPS=3680
export MAX_STEPS=${CDI_SET_MAX_STEPS:-2000}
#export OPT_LAMB_BETA_1=0.60466
export OPT_LAMB_BETA_1=${CDI_SET_BETA1:-0.66}
#export OPT_LAMB_BETA_2=0.85437
export OPT_LAMB_BETA_2=${CDI_SET_BETA2:-0.996}
#export START_WARMUP_STEP=0
export START_WARMUP_STEP=${CDI_SET_START_WARMUP:-0}
export WARMUP_STEPS=${CDI_SET_WARMUP_STEPS:-0}
