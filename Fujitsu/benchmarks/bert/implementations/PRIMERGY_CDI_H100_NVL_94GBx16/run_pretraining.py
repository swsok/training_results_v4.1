...
def prepare_model_and_optimizer(args, device, stream):
    ...
    if args.distributed_lamb:
        ...
        print("create Distributed Fused LAMB with verbose=1")
        optimizer = DistributedFusedLAMB(optimizer_grouped_parameters, lr=args.learning_rate, verbose=1,
        ...
        print("optimizer rank_in_group: {}, world_size:{}, group_size:{}, available_ranks:{}, _rs_st:{}, _rs_pg:{}".format(
            optimizer._rank_in_group, optimizer._world_size, optimizer._group_size, optimizer._available_ranks, 
            optimizer._rs_st, optimizer._rs_pg))
    else:
